...
Status 2026-09-20: 3a landed in `f88a207` and is verified offline; 3b-3e are not
built. The steps ship one at a time. The step letters are kept because the portfolio
