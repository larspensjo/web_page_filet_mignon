...
const CACHE_FILENAME: &str = ".triage_cache.ron";
...
pub(crate) fn default_triage_cache_path() -> PathBuf {
    std::env::current_dir()
...
pub(crate) fn load_triage_cache(path: &Path) -> TriageCache {
...
mod tests {
    ...
    fn save_then_load_roundtrip() {
        ...
        save_triage_cache(&cache, &path).unwrap();
