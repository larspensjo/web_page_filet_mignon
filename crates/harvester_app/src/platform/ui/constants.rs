...
pub const BTN_PROMPT_LAB_SECTION_COMPARE: ControlId = ControlId::new(3109);
pub const BTN_PROMPT_LAB_SECTION_CONTEXT: ControlId = ControlId::new(3110);
pub const BTN_PROMPT_LAB_SECTION_TEMPLATE: ControlId = ControlId::new(3111);
pub const BTN_PROMPT_LAB_SECTION_RUN_DETAILS: ControlId = ControlId::new(3112);
