...
pub use briefing::BRIEFING_PROMPT_V6 as BRIEFING_PROMPT;
pub use briefing::{
    BRIEFING_PROMPT_V1, BRIEFING_PROMPT_V2, BRIEFING_PROMPT_V3, BRIEFING_PROMPT_V4,
    BRIEFING_PROMPT_V5, BRIEFING_PROMPT_V6,
};
...
pub fn register_defaults(registry: &mut super::PromptRegistry) {
    ...
    registry.set_active(
        ...
        briefing::BRIEFING_PROMPT_V6.version,
    );
}
...
mod tests {
    ...
    #[test]
    fn aggregate_briefing_active_version_is_v6() {
        let mut registry = PromptRegistry::new();
        register_defaults(&mut registry);
        let active = registry
            .active(PromptId::AggregateBriefing)
            .expect("active AggregateBriefing prompt");
        assert_eq!(active.version, 6);
    }

    #[test]
    fn register_defaults_registers_six_aggregate_briefing_versions() {
        let mut registry = PromptRegistry::new();
        register_defaults(&mut registry);
